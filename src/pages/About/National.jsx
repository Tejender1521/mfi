...
import aastha from "../../images/about/national/aastha.jpeg";
...
import vijay from "../../images/about/national/vijay.jpeg";
import santosh from "../../images/about/national/santosh.jpeg";
...
function National() {
  const data = [
    ...
    { name: "Vijay Sharma", image: vijay, tag: "Vice-President" },
    {
      name: "Shishir Srivastav",
      image: shishir,
      tag: "Vice-President (Global Chapter)",
    },
    ...
    {
      name: "Sanjeev K Ahuja",
      image: sanjaeev,
      tag: "Vice President, Asia Chapter",
    },
    { name: "Neha Singh", image: neha, tag: "National Executive Member" },
    { name: "Santosh Rao", image: santosh, tag: "National Executive Member" },
    { name: "Aastha Srivastav", image: aastha, tag: "Executive Member" },
